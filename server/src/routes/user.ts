...
router.get('/:rut_usuario',getUser);   // si quieren q se verifique el token de la sesion se debe agregar validateToken. ej: router.get('/:rut_usuario',validateToken,getUser);
