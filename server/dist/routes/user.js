...
router.get('/list', auth_1.default, user_1.getUsers);
...
router.delete('/:rut_usuario', auth_1.default, user_1.deleteUser);
router.put('/:rut_usuario', auth_1.default, user_1.updateUser); // si la ruta tiene :rut_usuario entonces significa q el rut se rescata desde la ruta. ej: un update hacia el usuario rut "00000-0" seria un put a la ruta localhost:3000/api/users/00000-0
